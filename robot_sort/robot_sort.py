class SortingRobot:
  ...
  def sort(self):
    ...
    # grab item at 0
    # go forward a space to 1 -> might not need this here
    # compare the item
      # if item held is larger, swap by:
      # going forward a space, swapping
      # go back a space to 0
      # swap
      # go forward a space to 1
